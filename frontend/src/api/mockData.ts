...
import { photoReferenceToUrl, attractionToApiFormat } from './converter'
...
export const mockResponse: any[] = mockSelectableAttractionList.map(attractionToApiFormat).map((attraction: any): any => {
  attraction[pictureURL] = photoReference
  return attraction
})
